...
import OrderActions from '../order-table/table-elements/row-elements/OrderActions';
import ClientDetails from '../order-table/table-elements/row-elements/ClientDetails';
import OrderItemsList from '../order-table/table-elements/row-elements/OrderItemsList';
        ...
        <div>
            ...
            <Grid className={classes.row} container alignItems="center">
                ...
                <Grid item xs={cellSizes[3]}>
                    {type==="archive"?"":getStatus(order.status)}
                </Grid>
